    ...
    <form
        ...
        <div>
            ...
            <input type="text" name="name"
                value="<?= old('name') ?>"
                class="w-full px-3 py-2 rounded bg-gray-200 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        ...
        <div class="flex justify-between items-center">
            <a href="<?= site_url('/users') ?>"
                class="px-4 py-2 bg-gray-200 rounded hover:bg-gray-50">Back</a>
