...
<div class="overflow-x-auto" x-data="deleteModal()">
        ...
        <tbody>
            ...
            <tr class="border-t border-gray-700">
                ...
                <td class="px-4 py-2 flex gap-2">
                    ...
                    <!-- Delete Button -->
                    <button
                        @click="confirmDelete(<?= $user['id'] ?>, '<?= esc($user['name'], 'js') ?>')"
    ...
    <div x-show="open" x-cloak class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
        <div @click.outside="open = false" class="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md">
